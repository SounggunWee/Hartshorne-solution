...
\item Write $f = ax^2 + bxy + cy^2 + dx + ey + g$ for $a,b,c,d,e,g\in k$. Since $k$ is algebraically closed, degree 2 term
        $ax^2 + bxy + cy^2$ can be decomposed into the product of two linear terms $u = a'x + b'y$ and $v = c'x + d'y$.
        If 
\end{enumerate}
\end{proof}
