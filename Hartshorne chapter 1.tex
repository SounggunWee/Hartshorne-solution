...
\item Let $f = ax^2 + bxy+cy^2 + dx+ey+g$. Since $k$ is algebraically closed, we can decompose $ax^2+bxy+cy^2$ into the product of 
        two linear terms $u = a'x+b'y$ and $v = c'x+d'y$.
\end{enumerate}
\end{proof}
